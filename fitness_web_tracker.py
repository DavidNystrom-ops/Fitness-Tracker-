...
with tab2:
    ...
    preset_exercises = ["Chest Press", "Goblet Squat","chest fly", "Tricep pulldown", "Lat Pulldown", "pallof press", "woodchopper", "Plank Hold", "Overhead Press", "Deadlift", "glute bridge", "Barbell Row", "calf raise", "Bicep Curl"]
